...
### ITware (2012 -...)
 * 2026 - RAG Chatbot Development - Automotive industry (JAPANESE AUTOMOTIVE COMPANY) (HU, JP) - Tech stack: AnythingLLM, Laravel, Filament, Material Design, Ollama, Python, MS Entra, nginx reverse proxy 
 * 2026 - SUNBEARS – SunBears Cloud Campus Sport Ecosystem development (Phase8 - Onogoro Note) (FBT) (JP) - Tech stack: Angular, Material Design, Firebase, Flutter, PWA (Vue), Speech-to-Text, Stripe, OpenAI
 * 2025 - LLM/OCR/RULE-based Depersonalizer Service Development (NAVÜ) (HU) - Tech stack: Ubuntu 22.04 LTS, Docker Engine 24.0+ és Docker Compose v2, Python 3.11, Node 22.0, Stripe, NVIDIA Container Toolkit, LLM, Ollama LLM (Gemma3, LLama3), Svelte, TypeScript, Python Flask, PostgreSQL, CloudFlare Turnstile, Prisma ORM, Kubernetes, OTP
